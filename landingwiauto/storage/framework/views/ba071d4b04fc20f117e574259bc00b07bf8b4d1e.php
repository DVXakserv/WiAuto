      ...
      <div id="sidebar-left" class="span2">
        <div class="nav-collapse sidebar-nav">
          <ul class="nav nav-tabs nav-stacked main-menu">
            ...
            <li><a href="<?php echo e(URL::to('/all-category')); ?>"><i class="icon-envelope"></i><span class="hidden-tablet"> All Categoru</span></a></li>
            <li><a href="<?php echo e(URL::to('/add-category')); ?>"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Category</span></a></li>
            <li><a href="<?php echo e(URL::to('/all-manufacture')); ?>"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Brands</span></a></li>
            <li><a href="<?php echo e(URL::to('/add-manufacture')); ?>"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Brand</span></a></li>
            <li>
              ...
              <ul>
                ...
                <li><a class="submenu" href="<?php echo e(URL::to('/all-product')); ?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Product</span></a></li>
            ...
            <li>
              ...
              <ul>
                ...
                <li><a class="submenu" href="<?php echo e(URL::to('/all-product')); ?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Slider</span></a></li>
                <li><a class="submenu" href="submenu3.html"><i class="icon-file-alt"></i><span class="hidden-tablet"> Sub Menu 3</span></a></li>
              </ul> 
            </li>
