<?php echo $__env->make('Wiauto.head', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('Wiauto.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<!--Carousel Wrapper-->
<!--Carousel Wrapper-->
<div id="carousel-example-2" class="carousel slide carousel-fade" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="carousel-item active">
      <div class="view">
        <img class="d-block w-100" src="<?php echo e(asset('image/1b2UXTl0rP4JIptlIbrc.jpg')); ?>"
          alt="First slide">
    ...
    <div class="carousel-item">
      <!--Mask color-->
      <div class="view">
        <img class="d-block w-100" src="<?php echo e(asset('image/bVzX7l0WihL52AEq6wNl.jpg')); ?>"
          alt="Second slide">
...
<!--================Home Banner Area =================-->
<?php echo $__env->make('WiAuto.agence', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <div class="row">
      <div class="col-md-6" style="margin-left: -9%;" >
        <div class="er_div_right " style="width: 110%; height: 100%;">
                <img  src="<?php echo e(asset('image/ak.jpg')); ?>">
              </div>
      </div>
        ...
        <div class="row justify-content-center py-3">
          ...
          <div class="col-lg-4 col-sm-6 mb-4">
            <div class="card shadow border-0">
              <div class="card-body">
                <div class="text-center">
                  <img src="<?php echo e(asset('image/car_rental-512.png')); ?>" width="80" alt="">
...
<?php echo $__env->make('Wiauto.footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
