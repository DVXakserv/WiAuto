                 ...
                 <div class="row">
                   <div class="col-md-8">
                     <div class="owl-carousel img-carousel">
                       <div class="item">
                        <a class="btn btn-zoom" href="<?php echo e(URL::to($product_by_details->product_image)); ?>" data-gal="prettyPhoto"><i class="fa fa-arrows-h"></i></a>
                        <a href="../uploads/2018/09/10/Screenshot_12.png" data-gal="prettyPhoto">
                        <img class="img-responsive" src="<?php echo e(URL::to($product_by_details->product_image)); ?>"alt=""/></a>
                       </div>
                    </div>
                  ...
                  <div class="col-md-4">
                      <div class="car-details">
                          <div class="list">
                              <ul>
                                  <li class="title">
                                      <h2> <?php echo e($product_by_details->product_name); ?> <span><?php echo e($product_by_details->brand_name); ?></span></h2>
                                      <li><?php echo e($product_by_details->product_model); ?></li>
                          ...
                          <div class="price">
                            <strong>$&nbsp;<?php echo e($product_by_details->price); ?></strong> <span>/for 1 day(s)</span> <i class="fa fa-info-circle"></i>
                          </div>
                      </div>
                 </div>
             </div>
...
<?php echo $__env->make('page.booking', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
