...
<div class="limiter">
    <div class="container-login100">
      <div class="wrap-login100" style="background-color: transparent;">
        <div class="login100-pic js-tilt" data-tilt>
          <img src="https://wiauto.net/wp-content/uploads/2020/02/logo-01.png" alt="IMG">
        </div>

        <form action="<?php echo e(url('wiauto/home')); ?>" method="post">
        <?php echo e(csrf_field()); ?>
          ...
          <div class="text-center p-t-12">
            ...
            <a class="txt2" href="<?php echo e(url('/forget_password')); ?>">
               Password?
            </a>
          </div>
