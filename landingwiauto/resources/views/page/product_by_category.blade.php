                    ...
                    <div class="thumbnail no-border no-padding thumbnail-car-card">
                     <div class="media">
                       <a class="media-link" data-gal="prettyPhoto"href="uploads/2018/09/10/Kaptur-packshot_1536x864.jpg.ximg.l_full_m.smart.jpg">
                        <img src="{{$v_product->product_image}}" alt="" style="height: 180px;" />
                            <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                       </a>
                                                        
                     </div>
                     <div class="caption text-center">
                     <h4 class="caption-title"><a href="#">{{$v_product->product_name}}</a>
                     </h4>
                     <div class="caption-text">Start from $ {{$v_product->price}}/per a day
                     </div>
                     <div class="buttons">
                     <a class="btn btn-theme ripple-effect" href="{{URL::to('/view_product/'.$v_product->product_id)}}">  Rent It</a>
                     </div>
                     <table class="table">
                         <tr>
